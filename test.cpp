...
int main(int argc, char** argv)
{
    ...
    if (sc != "") {
      ...
      cout << "CASE 1 passed for empty string" << endl;
    ...
    if (sc != "") {
      ...
      cout << "CASE 2 passed for something not in trie" << endl;

    // ADDED TEST CASE FOR NOT MISSPELLED (in trie)
    sc = scTrie.checkSpelling("stop");
    if (sc != "stop") {
      cout << "FAILED for word in trie" << endl;
    }
    else
      cout << "TEST for word in trie PASSED" << endl;
    ...
    if (sc != "stop") {
      ...
      cout << "CASE 3 passed for stoo -> stop" << endl;
    ...
    if (sc != "stone") {
      ...
      cout << "CASE 4 passeed for stone for stzzz" << endl;
